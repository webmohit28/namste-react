  ...
  return (props) => {
    return (
      <div className="col-md-12">
        <span> {props.resData.info.availability.opened ? 'Open' : 'closed'} </span>
